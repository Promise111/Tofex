...
// AdminListPaymentAccounts lists all payment destinations.
//
...
// AdminCreatePaymentAccount adds a bank account customers can pay into (super admin).
//
...
//	@Accept			json
//	@Produce		json
//	@Param			body	body		apidocs.CreatePaymentAccountRequest	true	"Bank account"
//	@Success		201		{object}	models.PaymentAccount
...
// AdminPatchPaymentAccount updates a payment account.
//
...
//	@Accept			json
//	@Produce		json
//	@Param			id		path	int									true	"Payment account ID"
//	@Param			body	body	apidocs.PatchPaymentAccountRequest	true	"Fields to update"
//	@Success		200		{object}	models.PaymentAccount
//	@Failure		400		{object}	apidocs.ErrorResponse
//	@Failure		401		{object}	apidocs.ErrorResponse
//	@Failure		403		{object}	apidocs.ErrorResponse
//	@Failure		404		{object}	apidocs.ErrorResponse
//	@Failure		500		{object}	apidocs.ErrorResponse
//	@Router			/api/v1/admin/payment-accounts/{id} [patch]
...
// AdminDeletePaymentAccount soft-deletes a payment account.
//
...
//	@Failure		404	{object}	apidocs.ErrorResponse
//	@Failure		500	{object}	apidocs.ErrorResponse
//	@Router			/api/v1/admin/payment-accounts/{id} [delete]
