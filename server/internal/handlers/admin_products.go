...
// AdminListProducts lists all products including inactive.
//
//	@Summary		List products (admin)
//	@Tags			admin-products
//	@Security		BearerAuth
//	@Produce		json
//	@Success		200	{object}	apidocs.ProductsListResponse
...
// AdminCreateProduct creates a catalog product.
//
...
//	@Accept			json
//	@Produce		json
//	@Param			body	body		apidocs.CreateProductRequest	true	"Product"
...
// AdminPatchProduct updates a product.
//
...
//	@Param			body	body	apidocs.PatchProductRequest	true	"Fields to update"
...
// AdminUploadProductImage uploads an image for a product.
//
