...
// AdminListRoles lists roles and their permissions.
//
//	@Summary		List roles
//	@Tags			admin-roles
//	@Security		BearerAuth
//	@Produce		json
//	@Success		200	{object}	apidocs.RolesListResponse
...
// AdminPatchRole updates permissions for a role (super_admin role is always wildcard).
//
...
//	@Param			body	body	apidocs.PatchRoleRequest	true	"Permission keys"
