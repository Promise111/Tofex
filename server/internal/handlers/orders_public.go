...
// PublicCreateOrder places a guest order with payment receipt proof.
//
...
//	@Produce		json
//	@Param			customer_name		formData	string	true	"Customer full name"
//	@Param			customer_email		formData	string	true	"Customer email"
//	@Param			customer_phone		formData	string	false	"Customer phone"
//	@Param			customer_note		formData	string	false	"Optional note"
//	@Param			payment_account_id	formData	int		true	"Active payment account ID"
//	@Param			items				formData	string	true	"JSON array of line items"
//	@Param			receipt				formData	file	true	"Payment receipt image"
//	@Success		201					{object}	apidocs.PublicCreateOrderResponse
